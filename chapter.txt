...
[^2]: This early work later became significant during the development of
    metabolic control analysis [@KB81]
...
![Example of JDesigner's visual format\label{Figure:jdesigner}](JDesigner1.eps)
...
math library, frequency analyzer, bifurcation discover and analysis modules, structural analysis modules and others. Further details to be found at <www.sys-bio.org>\label{Figure:sbw}](sbwFig.eps)
...
![The Release of Software Tools for Computational Systems Biology over Time. Note the spike in the last five years.\label{figure:apps}](ToolsPerYear.pdf)
...
:   This is the main BioSPICE site. This site
